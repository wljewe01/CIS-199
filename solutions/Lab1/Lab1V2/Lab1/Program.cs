...
// Version 2 - Typical solution that keeps track of each calculation
// in a separate variable and performs formatting inside composite placeholders.
// Uses Parse methods.
...
namespace Lab1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            WriteLine("{0:F3} + {1:F3} = {2:F3}", num1, num2, sum);
            WriteLine("{0:F3} - {1:F3} = {2:F3}", num1, num2, difference);
            WriteLine("{0:F3} * {1:F3} = {2:F3}", num1, num2, product);
            WriteLine("{0:F3} / {1:F3} = {2:F3}", num1, num2, quotient);
            WriteLine("---Mean of");
            WriteLine("{0:F3} , {1:F3} = {2:F3}", num1, num2, mean);
        }
    }
}